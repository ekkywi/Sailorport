...
| Catalog app (Postgres, Redis, …) | 🔄 Step 22 (22a–22b ✅) | pull image → run (belum) |
...
**Selesai:** MVP core + Step 18–21 + **22a–22b** (catalog app fields + list API). **Next:** Step 22c create `catalog_app` (`docs/PRODUCT.md`, `docs/PROGRESS.md`).
